...
final class ChatPresenter: ChatPresentationLogic {
	...
	/// Метод для получения мок данных, при первом входе в приложение будет вызван в обработке неудачного запроса, в него будут переданы локальные сообщения если такие есть и счетчик
